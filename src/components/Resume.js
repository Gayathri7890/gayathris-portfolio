...
export default function Resume() {
        const config ={
            link:'https://www.canva.com/design/DAGWRZnRMOg/OzFgrY39FZAH3cO4Vwh40g/view?utm_content=DAGWRZnRMOg&utm_campaign=designshare&utm_medium=link&utm_source=viewer'
        }
