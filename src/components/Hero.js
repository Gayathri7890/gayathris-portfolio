...
export default function Hero() {
  const config ={
    ...
    social:{
    github:"https://github.com/Gayathri7890/",
    whatsapp:"https://wa.me/9500847571/",
    instagram:"https://www.instagram.com/gayathri12309/"
    } 
    ...
    return <section className='flex flex-col  md:flex-row px-5 py-32  bg-secondary justify-center ' id='hero'>
        <div className=' md:  w-1/2 flex flex-col'>
            <h1 className=' text-white text-4xl font hero-font '>Hi,<br/> iam Gayathri
